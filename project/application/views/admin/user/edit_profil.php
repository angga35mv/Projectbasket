...
<form class="form-horizontal" action="<?= base_url()?>admin/edit_data" method="post"  enctype="multipart/form-data">
  <fieldset>
  ...
  <div class="form-group">
      ...
      <div class="col-lg-8">
        <div class="Jenis Kelamin">
          <label>
            <input type="radio" name="inputTipe" id="optionsRadios1" value="0" <?php if($tipe_anggota==0) {echo "checked='checked'";} ?> >
            User
          </label>
        </div>
        <div class="radio">
          <label>
            <input type="radio" name="inputTipe" id="optionsRadios2" value="1" <?php if($tipe_anggota==1) {echo "checked='checked'";} ?>>
            Admin
          </label>
        </div>
      </div>
