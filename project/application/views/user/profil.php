    ...
    <table >
      ...
      <tr>
        <td colspan="3" class="col-lg-13 control-label">
          ...
          -->
          <center>
            <a class="btn btn-primary" href="<?= base_url()?>user/showeditprofil/<?= $id_anggota?>">Edit Data</a>
            <a class="btn btn-primary" href="<?= base_url()?>user/showeditfoto/<?= $id_anggota?>">Edit Foto</a>
          </center>
        </td>
      </tr>
    </table>
